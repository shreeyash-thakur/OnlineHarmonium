  ...
  head: () => ({
    meta: [
      { title: "Online Harmonium - Play Free Virtual Harmonium Keyboard Online" },
      {
        name: "description",
        content:
          "Play harmonium online for free using our virtual harmonium keyboard. Practice Sa Re Ga Ma notes, learn harmonium songs, and play Indian classical music on mobile and computer.",
      },
      {
        name: "keywords",
        content:
          "online harmonium, play harmonium online, virtual harmonium, online harmonium keyboard, free harmonium online, harmonium notes, Sa Re Ga Ma harmonium, harmonium practice online, learn harmonium online, harmonium songs for beginners, Indian musical instrument online, virtual Indian keyboard",
      },
      {
        name: "robots",
      ...
      {
        property: "og:title",
        content: "Online Harmonium - Play Free Virtual Harmonium Keyboard Online",
      },
      {
          ...
          "@graph": [
            {
              ...
              description:
                "Free online virtual harmonium with realistic sampled reeds and sargam labels.",
            },
            {
              "@type": "WebApplication",
              ...
              url: "https://onlineharmonium.vercel.app/",
              description:
                "Free online harmonium with realistic sampled reeds and sargam labels. Play Indian classical music, practice Sa Re Ga Ma, and learn harmonium songs.",
            ...
            },
            {
              ...
              mainEntity: [
                {
                  "@type": "Question",
                  name: "What is an online harmonium?",
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "An online harmonium is a virtual/web-based version of the traditional Indian harmonium. It allows you to play harmonium directly in your browser without downloading any software. You can use your mouse, touch screen, or computer keyboard to play notes.",
                  },
                },
                {
                  "@type": "Question",
                  name: "Can I play harmonium online for free?",
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Yes! Our online harmonium is completely free to use. No downloads, no sign-ups, no hidden fees. Just open the website and start playing harmonium instantly in your browser.",
                  },
                },
                {
                  "@type": "Question",
                  name: "Can beginners learn harmonium using this website?",
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Absolutely! Our virtual harmonium is perfect for beginners. It features sargam labels (Sa Re Ga Ma), western note labels, keyboard mappings, and practice modes to help you learn harmonium step by step.",
                  },
                },
                {
                  "@type": "Question",
                  name: "What are Sa Re Ga Ma notes?",
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Sa Re Ga Ma are the seven basic notes (swaras) in Indian classical music. Sa is the tonic — the reference pitch everything else is measured from — so its Western letter depends on the key you choose. When Sa = C, the notes map to C, D, E, F, G, A, B. On our online harmonium, these are labeled on the keys to help you learn and practice Indian classical music.",
                  },
                },
                {
                  "@type": "Question",
  ...
  return (
    <section className="relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 pt-16 pb-24 text-center">
        ...
        >
          Experience the best <strong>online harmonium</strong> with realistic sampled reeds and
          breathing bellows. Practice <strong>Sa Re Ga Ma</strong> notes, learn harmonium songs, and
          play Indian classical music. Our <strong>virtual harmonium keyboard</strong> works
          instantly in your browser - no downloads required. Perfect for beginners and professionals
          alike.
        </motion.p>
          ...
          <div className="wood-panel rounded-3xl p-6 relative">
            ...
            >
              <div className="absolute inset-0 flex">
                {Array.from({ length: 22 }).map((_, i) => (
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(180deg, oklch(0.97 0.01 85), oklch(0.88 0.015 80))",
                    }}
                  />
                ))}
              </div>
              <div className="absolute inset-0 flex pointer-events-none">
                {[1, 3, -1, 6, 8, 10, -1, 13, 15, -1, 18, 20].map((pos, i) =>
                  pos < 0 ? (
                    <div key={i} className="flex-1" />
                  ) : (
                    <div
                      key={i}
                      className="absolute top-0 h-[62%] rounded-b-md"
                      style={{
                        left: `${(pos / 22) * 100}%`,
                        width: `${(1 / 22) * 100 * 0.7}%`,
                        background:
              ...
              <motion.div
                ...
                style={{
                  background:
                    "linear-gradient(105deg, transparent 40%, oklch(0.9 0.15 85 / 0.15) 50%, transparent 60%)",
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="max-w-3xl">
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              An <strong>online harmonium</strong> is a digital, web-based version of the
              traditional Indian harmonium (also known as a reed organ or pump organ). It allows
              musicians, students, and enthusiasts to play the harmonium directly in their web
              browser without needing to download any software or purchase expensive equipment.
            </p>
            <p>
              The <strong>virtual harmonium</strong> replicates the sound and feel of a real
              harmonium using high-quality audio samples and realistic interaction design. You can
              use your mouse, touch screen, or computer keyboard to play notes, making it accessible
              for everyone.
            </p>
            <p>
              Learning <strong>harmonium online</strong> has become increasingly popular because it
              offers convenience and accessibility. Whether you want to practice{" "}
              <strong>Sa Re Ga Ma</strong> (the seven basic notes of Indian classical music), learn
              new <strong>harmonium songs for beginners</strong>, or practice{" "}
              <strong>harmonium notes</strong> for riyaz (daily practice), an{" "}
              <strong>online harmonium keyboard</strong> provides a flexible and effective tool.
            </p>
            <p>
              Our <strong>free harmonium online</strong> features a 27-key scale-changer layout,
              sargam labels, western note labels, and MIDI support, making it one of the most
              comprehensive <strong>Indian musical instruments online</strong> available.
            </p>
          </div>
        </div>
      </div>
    ...
    <section className="py-24 border-t border-white/5 bg-gradient-to-b from-transparent to-white/[0.02]">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <p className="text-muted-foreground max-w-2xl mb-12">
          Getting started with our <strong>virtual harmonium</strong> is easy. Follow these simple
          steps to begin your
          ...
          <div className="grid sm:grid-cols-2 gap-6 text-sm">
            <div>
              ...
              <p className="text-muted-foreground mb-2">
                Play the <strong>online harmonium keyboard</strong> using your computer keys. Each
                note is mapped to a convenient key. For example,{" "}
                <kbd className="px-2 py-1 rounded bg-white/10 font-mono">E</kbd> is Sa. This makes{" "}
                <strong>harmonium practice online</strong> fast and intuitive.
              </p>
            </div>
            <div>
              <h4 className="font-semibold mb-2 text-foreground">📱 Mobile Touch</h4>
              <p className="text-muted-foreground mb-2">
                Touch any key on the screen to play. The interface is fully responsive and optimized
                for phones and tablets. Start <strong>learning harmonium online</strong> anywhere,
                anytime.
              </p>
            </div>
          </div>
    ...
    <section className="py-24 border-t border-white/5">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <p className="text-muted-foreground max-w-3xl mb-8">
          Understanding <strong>harmonium notes</strong> is essential for playing Indian classical
          music. The seven basic notes, known as <strong>Sa Re Ga Ma</strong> (Sargam), form the
        ...
        <div className="glass rounded-2xl p-6 sm:p-8 mb-6">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            In Indian classical music, <strong>Sa</strong> is the <em>tonic</em> — the reference
            pitch everything else is measured from. Sa is not fixed to any particular Western note.
            The mapping below shows the notes when Sa = C; if you choose a different tonic, every
            Western note shifts accordingly. Sa and Pa are always natural (achal); the other five
            can be komal (flat) or, for Ma, tivra (sharp) depending on the raga.
          </p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              {
                sargam: "Sa (S)",
                western: "C (Do) — when Sa = C",
                desc: "The tonic note. The starting point of all ragas. Always shuddha (natural).",
              },
              {
                sargam: "Re (R)",
                western: "D (Re) — when Sa = C",
                desc: "The second note. Shuddha or komal (flat) depending on the raga.",
              },
              {
                sargam: "Ga (G)",
                western: "E (Mi) — when Sa = C",
                desc: "The third note. Shuddha or komal (flat) depending on the raga.",
              },
              {
                sargam: "Ma (M)",
                western: "F (Fa) — when Sa = C",
                desc: "The fourth note. Shuddha or tivra (sharp) depending on the raga.",
              },
              {
                sargam: "Pa (P)",
                western: "G (Sol) — when Sa = C",
                desc: "The fifth note. Always shuddha (natural), like Sa.",
              },
              {
                sargam: "Dha (D)",
                western: "A (La) — when Sa = C",
                desc: "The sixth note. Shuddha or komal (flat) depending on the raga.",
              },
              {
                sargam: "Ni (N)",
                western: "B (Ti) — when Sa = C",
                desc: "The seventh note. Shuddha or komal (flat) depending on the raga.",
              },
            ].map((note) => (
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="glass rounded-2xl p-6">
            ...
            <p className="text-sm text-muted-foreground">
              The lower octave notes are indicated with a dot below the note (e.g., ऋ). On our
              harmonium, these appear as the leftmost keys. Practice these to develop control over
              the lower register.
            </p>
          </div>
          <div className="glass rounded-2xl p-6">
            ...
            <p className="text-sm text-muted-foreground">
              The upper octave notes are shown with a dot above (e.g., त). These are the rightmost
              keys on the keyboard. Mastering the upper octave is crucial for playing complex ragas
              and melodies.
            </p>
          </div>
        </div>
    ...
    <section className="py-24 border-t border-white/5">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <p className="text-muted-foreground max-w-2xl mb-8">
          Explore our collection of <strong>harmonium songs for beginners</strong> and intermediate
          players. Practice traditional ragas, bhajans, and aartis on your{" "}
          <strong>virtual harmonium</strong>.
        </p>
...
const features = [
  ...
  {
    icon: Music,
    title: "Real sampled reeds",
    desc: "Warm harmonium tone with authentic bellows breath.",
  },
...
function Modes() {
  const items = [
    {
      title: "Harmonium",
      desc: "Play a full 27-key scale-changer harmonium with authentic reed presets.",
      to: "/play",
    },
    {
      title: "MIDI Play",
      desc: "Plug in a MIDI keyboard for expressive, low-latency practice.",
      to: "/play",
    },
