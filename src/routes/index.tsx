  ...
  head: () => ({
    meta: [
      { title: "Virtual Harmonium Online — Free Browser Harmonium, Tanpura & Metronome | Riyaz" },
      {
        name: "description",
        content:
          "Play a free online harmonium in your browser with realistic sampled reeds, sargam labels, tanpura drone, and metronome. No installs — instant, MIDI-ready, works on mobile and desktop.",
      },
      {
        name: "keywords",
        content:
          "virtual harmonium, online harmonium, harmonium online, harmonium app, tanpura online, shruti box, sargam, riyaz, indian classical music, learn harmonium",
      },
      ...
      { property: "og:title", content: "Virtual Harmonium Online — Play Free in Your Browser" },
      {
        ...
        content:
          "Realistic sampled harmonium with tanpura, shruti box, metronome and sargam learning tools. Free, instant, no install.",
      },
      ...
      { name: "twitter:title", content: "Virtual Harmonium Online — Riyaz" },
      {
        ...
        content:
          "Play a beautifully crafted online harmonium with tanpura and metronome. Free, in your browser.",
      },
    ],
          ...
          "@graph": [
            {
              ...
              url: "/",
              description:
                "Free online harmonium with realistic sampled reeds, tanpura, shruti box, metronome, and sargam labels.",
            ...
            },
            {
              ...
              mainEntity: [
                {
                  "@type": "Question",
                  name: "Is the virtual harmonium free?",
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Yes. Riyaz is completely free to play in your browser with no installs or sign-ups.",
                  },
                },
                {
                  "@type": "Question",
                  ...
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Yes. The harmonium keyboard is touch-optimised and scales to fit any phone, tablet or laptop screen.",
                  },
                },
                {
                  "@type": "Question",
                  name: "Can I use my computer keyboard?",
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Yes. Every key is mapped to a computer key — Sa is on E — so you can play without a mouse.",
                  },
                },
                {
                  "@type": "Question",
                  name: "Does it include tanpura and metronome?",
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Yes. A tanpura drone and visual metronome are built in alongside the harmonium.",
                  },
                },
              ],
            },
  ...
  return (
    <section className="relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 pt-16 pb-24 text-center">
        ...
        >
          Realistic reeds, breathing bellows, a built-in tanpura and shruti box — crafted for riyaz,
          bhajans, film songs and classical practice.
        </motion.p>
...
function Modes() {
  const items = [
    {
      title: "Harmonium",
      desc: "Play a full 3–5 octave harmonium with four premium presets.",
      to: "/play",
    },
